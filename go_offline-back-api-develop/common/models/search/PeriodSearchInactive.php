...
/**
 * common\models\search\PeriodSearchInactive represents the model behind the search form about `common\models\Period`.
 */
 class PeriodSearchInactive extends Period
{
    /**
     * @inheritdoc
     */
