...
/**
 * common\models\search\UserPeriodSearch represents the model behind the search form about `common\models\UserPeriod`.
 */
 class UserPeriodSearch extends UserPeriod
{
    /**
     * @inheritdoc
     */
