...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'module_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\common\models\Module::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
        ...
        'school_year_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\common\models\SchoolYear::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
                'options' => ['placeholder' => 'Choose Topic'],
            ],
            'columnOptions' => ['width' => '200px']
        ],
